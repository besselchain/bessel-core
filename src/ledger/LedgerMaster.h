...
#ifndef BESSEL_APP_LEDGER_LEDGERMASTER_H_INCLUDED
#define BESSEL_APP_LEDGER_LEDGERMASTER_H_INCLUDED
...
public:
	...
	virtual TER doTransaction(STTx::ref txn,TransactionEngineParams params, bool& didApply) = 0;
