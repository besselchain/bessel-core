...
#ifndef BESSEL_APP_LEDGER_ORDERBOOKITERATOR_H_INCLUDED
#define BESSEL_APP_LEDGER_ORDERBOOKITERATOR_H_INCLUDED

#include <ledger/DirectoryEntryIterator.h>
#include <protocol/Indexes.h>

//  TODO Split these to separate files and de-inline the definitions
