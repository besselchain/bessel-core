...
#ifndef BESSEL_APP_LEDGER_LEDGERHISTORY_H_INCLUDED
#define BESSEL_APP_LEDGER_LEDGERHISTORY_H_INCLUDED
...
private:
    ...
    */
    ...
    typedef TaggedCache<LedgerIndex, std::pair<LedgerHash, LedgerHash>> ConsensusValidated;
