...
{
    {
        ...
        WriteLog (lsDEBUG, OrderBookDB) << "Advancing from " << mSeq << " to " << seq;
    ...
    if (getConfig().RUN_STANDALONE)
        ...
        getApp().getJobQueue().addJob(jtUPDATE_PF, "OrderBookDB::update", std::bind(&OrderBookDB::update, this, ledger));
}
