...
LedgerProposal::LedgerProposal (uint256 const& pLgr, std::uint32_t seq,
                                ...
                                BesselAddress const& naPeerPublic, uint256 const& suppression) 
...
LedgerProposal::LedgerProposal (BesselAddress const& naPub, 
                                BesselAddress const& naPriv,
...
LedgerProposal::LedgerProposal (uint256 const& prevLgr
                                , uint256 const& position
                                , std::uint32_t closeTime) 
                                : mPreviousLedger (prevLgr)
                                , mCurrentHash (position)
