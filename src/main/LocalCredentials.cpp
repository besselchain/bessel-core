...
bool LocalCredentials::nodeIdentityCreate ()
{
    ...
    //
    BesselAddress   naSeed          = BesselAddress::createSeedRandom ();
    BesselAddress   naNodePublic    = BesselAddress::createNodePublic (naSeed);
    BesselAddress   naNodePrivate   = BesselAddress::createNodePrivate (naSeed);
