...
#ifndef BESSEL_APP_MAIN_LOADMANAGER_H_INCLUDED
#define BESSEL_APP_MAIN_LOADMANAGER_H_INCLUDED
...
public:
    ...
    */
    //  NOTE it seems that the deadlock detector has an "armed" state to prevent it
...
std::unique_ptr<LoadManager> make_LoadManager (beast::Stoppable& parent, beast::Journal journal);
