...
#ifndef BESSEL_APP_MAIN_LOCALCREDENTIALS_H_INCLUDED
#define BESSEL_APP_MAIN_LOCALCREDENTIALS_H_INCLUDED
...
public:
    ...
    BesselAddress const& getNodePublic () const
    {
        return mNodePublicKey;
    }

    BesselAddress const& getNodePrivate () const
    {
...
private:
    ...
    BesselAddress mNodePublicKey;
    BesselAddress mNodePrivateKey;
};
