...
#ifndef BESSEL_APP_MAIN_APPLICATION_H_INCLUDED
#define BESSEL_APP_MAIN_APPLICATION_H_INCLUDED
...
//  TODO Fix forward declares required for header dependency loops
...
*/
std::unique_ptr<Application> make_Application(Logs& logs);
