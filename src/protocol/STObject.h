...
#ifndef BESSEL_PROTOCOL_STOBJECT_H_INCLUDED
#define BESSEL_PROTOCOL_STOBJECT_H_INCLUDED

#include <common/base/CountedObject.h>
#include <protocol/STAmount.h>
#include <protocol/STPathSet.h>
#include <protocol/STVector256.h>
#include <protocol/SOTemplate.h>
#include <protocol/impl/STVar.h>
...
public:
    ...
    //  NOTE does this return an expensive copy of an object with a
    //             dynamic buffer?
    //  TODO Remove this function and fix the few callers.
    ...
    BesselAddress getFieldAccount (SField const& field) const;
    ...
    */
    ...
    void setFieldAccount (SField const& field, BesselAddress const& addr)
    {
