...
#ifndef BESSEL_PROTOCOL_TER_H_INCLUDED
#define BESSEL_PROTOCOL_TER_H_INCLUDED

#include <string>

namespace bessel {

// See https://bessel.com/wiki/Transaction_errors

//  TODO consider renaming TER to TxErr or TxResult for clarity.
//
enum TER    // aka TransactionEngineResult
{
    ...
    telINSUF_FUND,
	telBAD_NICKNAME,
    telBAD_CONTRACT_INIT,
    telBAD_CONTRACT_INVOKE,
    ...
    temBAD_PATH,
    temBAD_PATH_LOOP,
    temBAD_SEND_SWT_LIMIT,
    temBAD_SEND_SWT_MAX,
    temBAD_SEND_SWT_NO_DIRECT,
    temBAD_SEND_SWT_PARTIAL,
    temBAD_SEND_SWT_PATHS,
    temBAD_SEQUENCE,
    temBAD_SIGNATURE,
    temBAD_SRC_ACCOUNT,
    ...
    terNO_BESSEL,        // Rippling not allowed
    ...
    // 100 .. 159 C
    //   Claim fee only (bessel transaction with no good paths, pay to
...
//  TODO group these into a shell class along with the defines above.
extern
bool
