...
#ifndef BESSEL_PROTOCOL_TXFLAGS_H_INCLUDED
#define BESSEL_PROTOCOL_TXFLAGS_H_INCLUDED
...
//  TODO Move all flags into this container after some study.
...
// AccountSet flags:
//  TODO Javadoc comment every one of these constants
...
const std::uint32_t asfDefaultBessel       = 8;
...
// Payment flags:
const std::uint32_t tfNoBesselDirect       = 0x00010000;
const std::uint32_t tfPartialPayment       = 0x00020000;
const std::uint32_t tfLimitQuality         = 0x00040000;
const std::uint32_t tfPaymentMask          = ~ (tfUniversal | tfPartialPayment | tfLimitQuality | tfNoBesselDirect);

// TrustSet flags:
const std::uint32_t tfSetfAuth             = 0x00010000;
const std::uint32_t tfSetNoBessel          = 0x00020000;
const std::uint32_t tfClearNoBessel        = 0x00040000;
const std::uint32_t tfSetFreeze            = 0x00100000;
const std::uint32_t tfClearFreeze          = 0x00200000;
const std::uint32_t tfTrustSetMask         = ~ (tfUniversal | tfSetfAuth | tfSetNoBessel | tfClearNoBessel
                                             | tfSetFreeze | tfClearFreeze);

// RelationSet flags:
const std::uint32_t tfRelationSetMask         = ~ (tfUniversal);

// AccountMerge flags:
const std::uint32_t tfAccountMergeMask         = ~ (tfUniversal);
