...
template <>
struct hash <bessel::error_code_i>
{
    std::size_t operator() (bessel::error_code_i value) const
    {
        return value;
    }
};
...
public:
        ...
        : m_unknown (rpcUNKNOWN, "unknown", "An unknown error code.")
    {
        ...
        add (rpcNO_NETWORK,            "noNetwork",         "Not synced to Bessel network.");
        add (rpcNO_PATH,               "noPath",            "Unable to find a bessel path.");
        ...
        add (rpcTX_BLOB_INVALID,       "txBlobInvalid",     "The tx_blob is an invalid parameter, parsing failure.");
        add(rpcARRAY_IS_EMPTY,         "arrayIsEmpty",      "Array is empty.");
    }
