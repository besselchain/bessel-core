...
{
    return mType == ltBESSEL_STATE;
}

BesselAddress STLedgerEntry::getOwner ()
{
    return getFieldAccount (sfAccount);
}

BesselAddress STLedgerEntry::getFirstOwner ()
{
    return BesselAddress::createAccountID (getFieldAmount (sfLowLimit).getIssuer ());
}

BesselAddress STLedgerEntry::getSecondOwner ()
{
    return BesselAddress::createAccountID (getFieldAmount (sfHighLimit).getIssuer ());
}
