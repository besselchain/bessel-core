...
bool transResultInfo (TER code, std::string& token, std::string& text)
{
    ...
    TxResultInfo const results[] =
    {
        ...
        { temBAD_SEND_SWT_NO_DIRECT,"temBAD_SEND_SWT_NO_DIRECT","Malformed: No Bessel direct is not allowed for SWT to SWT."    },
        ...
        { temBESSEL_EMPTY,          "temBESSEL_EMPTY",          "PathSet with no paths."                                        },
        ...
        { terNO_BESSEL,             "terNO_BESSEL",             "Path does not permit rippling."                                },
