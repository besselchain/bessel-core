...
#ifndef BESSEL_PROTOCOL_STLEDGERENTRY_H_INCLUDED
#define BESSEL_PROTOCOL_STLEDGERENTRY_H_INCLUDED
...
public:
    ...
    bool hasTwoOwners ();   // This node has two nodes that own it (like bessel balance)
    BesselAddress getOwner ();
    BesselAddress getFirstOwner ();
    BesselAddress getSecondOwner ();
