...
#ifndef BESSEL_PROTOCOL_ERRORCODES_H_INCLUDED
#define BESSEL_PROTOCOL_ERRORCODES_H_INCLUDED
...
//  NOTE These are outside the RPC namespace
...
//  NOTE these should probably not be in the RPC namespace.
