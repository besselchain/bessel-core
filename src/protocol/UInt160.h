...
#ifndef BESSEL_PROTOCOL_UINT160_H_INCLUDED
#define BESSEL_PROTOCOL_UINT160_H_INCLUDED
...
template <>
struct hash <bessel::uint160> : bessel::uint160::hasher
{
    //  NOTE broken in vs2012
    //using bessel::uint160::hasher::hasher; // inherit ctors
};
