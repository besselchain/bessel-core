...
#ifndef BESSEL_PROTOCOL_LEDGERFORMATS_H_INCLUDED
#define BESSEL_PROTOCOL_LEDGERFORMATS_H_INCLUDED
...
enum LedgerSpecificFlags
{
    ...
    lsfNoFreeze         = 0x00200000,   // True, cannot freeze bessel states
    lsfGlobalFreeze     = 0x00400000,   // True, all assets frozen
    lsfDefaultBessel   = 0x00800000,   // True, trust lines allow rippling by default
    ...
    lsfLowNoBessel     = 0x00100000,
    lsfHighNoBessel    = 0x00200000,
