...
#ifndef BESSEL_PROTOCOL_HASHPREFIX_H_INCLUDED
#define BESSEL_PROTOCOL_HASHPREFIX_H_INCLUDED
...
/** Prefix for hashing functions.
    ...
    @note Hash prefixes are part of the Bessel protocol.
...
public:
    ...
    //  TODO Expand the description to complete, concise sentences.
    //
