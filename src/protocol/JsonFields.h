...
#ifndef BESSEL_PROTOCOL_JSONFIELDS_H_INCLUDED
#define BESSEL_PROTOCOL_JSONFIELDS_H_INCLUDED
...
JSS ( Timestamp );                   // in/out: TransactionSign; field.
JSS ( SetFlag );                    // field.
JSS ( TakerGets );                  // field.
JSS ( TakerPays );                  // field.
...
JSS ( alternatives );               // out: PathRequest, BesselPathFind
...
JSS ( base_fee_swt );               // out: NetworkOPs
...
JSS ( destination_account );        // in: PathRequest, BesselPathFind
JSS ( destination_amount );         // in: PathRequest, BesselPathFind
JSS ( destination_currencies );     // in: PathRequest, BesselPathFind
...
JSS ( issuer );                     // in: BesselPathFind, Subscribe,
...
JSS ( ledger_hash );                // in: LookupLedger, LedgerRequest,
                                    //     BesselPathFind, TransactionEntry,
                                    //     handlers/Ledger
...
JSS ( relation_type);                 // out:AccountRelation
...
JSS ( no_bessel );                  // out: AccountLines
JSS ( no_bessel_peer );             // out: AccountLines
JSS ( node );                       // in: UnlAdd, UnlDelete
JSS(nickname);                                  // out: LedgerEntrySet, LedgerEntry
...
JSS ( Operations );                 //in TransactionSign
JSS ( Operation );
JSS ( params );                     // RPC
...
JSS ( paths );                      // in: BesselPathFind
JSS ( paths_canonical );            // out: BesselPathFind
JSS ( paths_computed );             // out: PathRequest, BesselPathFind
...
JSS ( reserve_base_swt );           // out: NetworkOPs
JSS ( reserve_inc );                // out: NetworkOPs
JSS ( reserve_inc_swt );            // out: NetworkOPs

JSS ( reset );			            // in : rpc_info

JSS ( fee_account );                // out: NetworkOPs
JSS ( fee_account_swt );             // out: NetworkOPs
JSS ( manager_account );            // out: NetworkOPs
JSS ( issuerop_account );           // out: NetworkOPs
JSS ( response );                   // websocket
JSS ( result );                     // RPC
JSS ( bessel_lines );              // out: NetworkOPs
JSS ( bessel_state );              // in: LedgerEntr
JSS ( rt_accounts );                // in: Subscribe, Unsubscribe
JSS ( sanity );                     // out: PeerImp
JSS ( search_depth );               // in: BesselPathFind
...
JSS ( source_account );             // in: PathRequest, BesselPathFind
JSS ( source_amount );              // in: PathRequest, BesselPathFind
JSS ( source_currencies );          // in: PathRequest, BesselPathFind
...
JSS ( total_users );                 //data_info
JSS ( issuer_Currency );
JSS ( total_amount );
JSS ( no_Amount );

JSS ( job_name );                 //thread_info 
#undef JSS
