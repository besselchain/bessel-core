...
#ifndef BESSEL_CORE_JOB_H_INCLUDED
#define BESSEL_CORE_JOB_H_INCLUDED
...
public:
    ...
    */
    //  NOTE I'd prefer not to have a default constructed object.
    ...
    //  TODO try to remove the dependency on LoadMonitor.
    Job (JobType type,
