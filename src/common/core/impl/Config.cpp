...
void Config::loadFromString (std::string const& fileContents)
{
    ...
    if (getSingleSection (secConfig, SECTION_VALIDATION_SEED, strTemp))
    {
        ...
        {
            VALIDATION_PUB = BesselAddress::createNodePublic (VALIDATION_SEED);
            VALIDATION_PRIV = BesselAddress::createNodePrivate (VALIDATION_SEED);
        }
    }
    ...
    if (getSingleSection (secConfig, SECTION_NODE_SEED, strTemp))
    {
        ...
        {
            NODE_PUB = BesselAddress::createNodePublic (NODE_SEED);
            NODE_PRIV = BesselAddress::createNodePrivate (NODE_SEED);
        }
    }
