...
#ifndef BESSEL_CORE_CONFIG_H_INCLUDED
#define BESSEL_CORE_CONFIG_H_INCLUDED
...
public:
    ...
    // DEPRECATED
    boost::filesystem::path     VALIDATORS_FILE;        // As specifed in besseld.cfg.

    /** List of Validators entries from besseld.cfg */
...
public:
    ...
    std::vector<std::string>    IPS;                    // Peer IPs from besseld.cfg.
    std::vector<std::string>    IPS_FIXED;              // Fixed Peer IPs from besseld.cfg.
    std::vector<std::string>    SNTP_SERVERS;           // SNTP servers from besseld.cfg.
    std::vector<std::string>    MYSQL_CONFIG;           // MYSQL config from besseld.cfg. add by frank for mysql config
    ...
    */
    ...
    // Validation
    BesselAddress               VALIDATION_SEED;
    BesselAddress               VALIDATION_PUB;
    BesselAddress               VALIDATION_PRIV;

    // Node/Cluster
    std::vector<std::string>    CLUSTER_NODES;
    BesselAddress               NODE_SEED;
    BesselAddress               NODE_PUB;
    BesselAddress               NODE_PRIV;
    ...
    BesselAddress              FEE_ACCOUNTID;
    BesselAddress              SMNG_ACCOUNTID;
    BesselAddress              SISSUER_ACCOUNTID;
