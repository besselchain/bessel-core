...
#ifndef BESSEL_BASICS_LOG_H_INCLUDED
#define BESSEL_BASICS_LOG_H_INCLUDED
...
private:
    ...
    */
    ...
    public:
        ...
        */
        //  NOTE The parameter is unfortunately a boost type because it
...
//------------------------------------------------------------------------------
//  DEPRECATED Temporary transition function until interfaces injected
inline
Logs&
deprecatedLogs()
{
...
//  DEPRECATED Inject beast::Journal instead
#define ShouldLog(s, k) \
    ::bessel::deprecatedLogs()[#k].active(::bessel::Logs::toSeverity (s))

#define WriteLog(s, k)                                              \
    if (!ShouldLog(s, k))                                           \
        do {} while (0);                                            \
    else                                                            \
        ::beast::Journal::Stream (::bessel::deprecatedLogs()[#k],   \
                                  ::bessel::Logs::toSeverity(s))
