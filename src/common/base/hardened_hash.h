...
#ifndef BESSEL_BASICS_HARDENED_HASH_H_INCLUDED
#define BESSEL_BASICS_HARDENED_HASH_H_INCLUDED
...
//
#ifndef BESSEL_NO_HARDENED_HASH_INSTANCE_SEED
# ifdef __GLIBCXX__
#  define BESSEL_NO_HARDENED_HASH_INSTANCE_SEED 1
# else
#  define BESSEL_NO_HARDENED_HASH_INSTANCE_SEED 0
# endif
#endif
...
make_seed_pair() noexcept
{
    ...
    static bessel::static_initializer <state_t> state;
...
private:
    ...
    init_seed_pair()
    {
        static bessel::static_initializer <detail::seed_pair,
...
*/
#if BESSEL_NO_HARDENED_HASH_INSTANCE_SEED
