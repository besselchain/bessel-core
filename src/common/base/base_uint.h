...
#ifndef BESSEL_BASICS_BASE_UINT_H_INCLUDED
#define BESSEL_BASICS_BASE_UINT_H_INCLUDED
...
public:
    ...
    */
    ...
    // Deprecated.
    bool isZero () const { return *this == bessel::zero; }
    bool isNonZero () const { return *this != bessel::zero; }
    void zero () { *this = bessel::zero; }
};
...
template <std::size_t Bits, class Tag>
struct hash<bessel::base_uint<Bits, Tag>>
{
    using argument_type = bessel::base_uint<Bits, Tag>;

    std::size_t
    operator()(argument_type const& u) const
    {
        return bessel::hardened_hash<>{}(u);
    }
};
