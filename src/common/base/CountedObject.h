...
#ifndef BESSEL_BASICS_COUNTEDOBJECT_H_INCLUDED
#define BESSEL_BASICS_COUNTEDOBJECT_H_INCLUDED
...
private:
    ...
    {
        static bessel::static_initializer<Counter> c;
        return *c;
    }
};
