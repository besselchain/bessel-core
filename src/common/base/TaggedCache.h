...
#ifndef BESSEL_BASICS_TAGGEDCACHE_H_INCLUDED
#define BESSEL_BASICS_TAGGEDCACHE_H_INCLUDED
...
*/
//  TODO Figure out how to pass through the allocator
template <
    class Key,
    class T,
...
public:
    //  TODO Change expiration_seconds to clock_type::duration
...
public:
    ...
    */
    ...
    //  NOTE It looks like this returns a copy of the data in
