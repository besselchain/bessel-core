...
#ifndef BESSEL_BASICS_RESOLVER_H_INCLUDED
#define BESSEL_BASICS_RESOLVER_H_INCLUDED
...
{
public:
    typedef std::function<void(std::string, std::vector<boost::asio::ip::tcp::endpoint>)> HandlerType;
