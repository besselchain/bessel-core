...
private:
    ...
    //  TODO hoist to remove template argument dependencies
    struct element
    ...
    //  TODO This should only be enabled for maps.
    ...
    public:
        ...
        //  NOTE WE might want only to enable these overloads
...
public:
    ...
    insert (const_iterator /*hint*/, value_type const& value)
    {
        //  TODO Figure out how to utilize 'hint'
        return insert (value);
    }
    ...
    //  TODO Respect is_transparent (c++14)
    template <class K>
    size_type
    ...
    //  TODO Should this return const reference for set?
    value_compare
    value_comp() const
    {
...
emplace (Args&&... args) ->
    typename std::enable_if <! maybe_multi,
        std::pair <iterator, bool>>::type
{
    //  NOTE Its unfortunate that we need to
