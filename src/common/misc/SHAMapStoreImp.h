...
#ifndef BESSEL_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
#define BESSEL_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
...
#include <data/nodestore/DatabaseRotating.h>
...
private:
    ...
    std::string const dbPrefix_ = "besseldb";
...
private:
    ...
    // If besseld is not healthy, defer rotate-delete.
