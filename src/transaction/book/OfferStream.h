...
#ifndef BESSEL_APP_BOOK_OFFERSTREAM_H_INCLUDED
#define BESSEL_APP_BOOK_OFFERSTREAM_H_INCLUDED

#include <functional>
#include <transaction/book/BookTip.h>
...
public:
    OfferStream (LedgerView& view, LedgerView& view_cancel, BookRef book, Clock::time_point when, beast::Journal journal);
