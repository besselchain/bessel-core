...
#ifndef BESSEL_APP_BOOK_QUALITY_H_INCLUDED
#define BESSEL_APP_BOOK_QUALITY_H_INCLUDED

#include <cstdint>
#include <ostream>

#include <transaction/book/Amount.h>
#include <transaction/book/Amounts.h>

namespace bessel {
namespace core {

// Bessel specific constant used for parsing qualities and other things
