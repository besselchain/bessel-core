...
#ifndef BESSEL_APP_TX_TRANSACTION_H_INCLUDED
#define BESSEL_APP_TX_TRANSACTION_H_INCLUDED
...
class Database;
    ...
    private:
        ...
        BesselAddress   mAccountFrom;
        BesselAddress   mFromPubKey;    // Sign transaction with this. mSignPubKey
        BesselAddress   mSourcePrivate; // Sign transaction with this.
