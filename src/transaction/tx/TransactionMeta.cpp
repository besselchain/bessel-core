...
namespace bessel {
    ...
    //  TODO rename class to TransactionMeta
    ...
    static void addIfUnique(std::vector<BesselAddress>& vector, BesselAddress const& address)
    {
    ...
    std::vector<BesselAddress> TransactionMetaSet::getAffectedAccounts()
    {
