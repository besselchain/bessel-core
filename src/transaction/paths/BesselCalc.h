...
#ifndef BESSEL_APP_PATHS_BESSELCALC_H_INCLUDED
#define BESSEL_APP_PATHS_BESSELCALC_H_INCLUDED
...
/** BesselCalc calculates the quality of a payment path.
