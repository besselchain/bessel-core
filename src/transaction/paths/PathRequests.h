...
#ifndef BESSEL_APP_PATHS_PATHREQUESTS_H_INCLUDED
#define BESSEL_APP_PATHS_PATHREQUESTS_H_INCLUDED
...
public:
    ...
    BesselLineCache::pointer getLineCache (
...
private:
    ...
    // Use a BesselLineCache
    BesselLineCache::pointer         mLineCache;
