...
#ifndef BESSEL_APP_PATHS_PATHREQUEST_H_INCLUDED
#define BESSEL_APP_PATHS_PATHREQUEST_H_INCLUDED
...
public:
    ...
    // update jvStatus
    Json::Value doUpdate (const std::shared_ptr<BesselLineCache>&, bool fast);
    InfoSub::pointer getSubscriber ();

private:
    bool isValid (BesselLineCache::ref crCache);
    void setValid ();
    ...
    BesselAddress raSrcAccount;
    BesselAddress raDstAccount;
