...
#ifndef BESSEL_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
#define BESSEL_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
...
private:
    ...
    PathCursor increment(int delta = 1) const {
        return {besselCalc_, pathState_, multiQuality_, nodeIndex_ + delta};
    }
    ...
    */
    ...
    {
        return besselCalc_.mActiveLedger;
    }
