...
#ifndef BESSEL_APP_DATA_NODESTORE_ROCKSDBQUICKFACTORY_H_INCLUDED
#define BESSEL_APP_DATA_NODESTORE_ROCKSDBQUICKFACTORY_H_INCLUDED

#include <BeastConfig.h>

// #include <bessel/unity/rocksdb.h>

#if BESSEL_ROCKSDB_AVAILABLE

#include <common/core/Config.h> //  Bad dependency
#include <data/nodestore/Factory.h>
#include <data/nodestore/Manager.h>
#include <data/nodestore/impl/DecodedBlob.h>
...
public:
    ...
    thread_entry (void* ptr)
    {
        ...
        pthread_setname_np (pthread_self(), ss.c_str ());
...
public:
    ...
    for_each (std::function <void(NodeObject::Ptr)> f)
    {
        ...
        for (it->SeekToFirst (); it->Valid (); it->Next ())
        {
            ...
            {
                //  NOTE What does it mean to find an
...
#endif //BESSEL_ROCKSDB_AVAILABLE endif

#endif //include header endif
