...
#ifndef BESSEL_APP_DATA_NODESTORE_ROCKSDBFACTORY_H_INCLUDED
#define BESSEL_APP_DATA_NODESTORE_ROCKSDBFACTORY_H_INCLUDED
...
public:
	...
	std::cout << "get rocksdb status: [" << status.code() << "]"  << std::endl;
	if (!status.ok () || !db)
