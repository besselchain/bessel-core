...
#ifndef BESSEL_NODESTORE_MANAGER_H_INCLUDED
#define BESSEL_NODESTORE_MANAGER_H_INCLUDED
...
public:
    ...
    */
    ...
    make_Backend (Section const& parameters, Scheduler& scheduler, beast::Journal journal) = 0;
