...
#ifndef BESSEL_PEERFINDER_IOSFORMAT_H_INCLUDED
#define BESSEL_PEERFINDER_IOSFORMAT_H_INCLUDED
...
std::basic_string <CharT, Traits, Allocator> heading (std::basic_string <CharT, Traits, Allocator> title,
                                                    int width = 80, 
                                                    CharT fill = CharT ('-'))
{
    title.reserve (width);
...
public:
    ...
    friend std::basic_ostream <CharT2, Traits2>& operator<< (std::basic_ostream <CharT2, Traits2>& os,
...
template <class CharT, class Traits, class Allocator>
field_t <CharT, Traits, Allocator> field (std::basic_string <CharT, Traits, Allocator> const& text,
                                          int width = 8, 
                                          int pad = 0, 
                                          bool right = false)
{
...
{
    return field_t<CharT, std::char_traits<CharT>, std::allocator<CharT>> (std::basic_string <CharT,
                                                                           std::char_traits <CharT>, 
                                                                           std::allocator <CharT>> (text),
                                                                           width, 
                                                                           pad, 
                                                                           right);
}
...
template <class CharT, class Traits, class Allocator>
field_t <CharT, Traits, Allocator> rfield (std::basic_string <CharT, Traits, Allocator> const& text,
