...
#ifndef BESSEL_PEERFINDER_SLOTIMP_H_INCLUDED
#define BESSEL_PEERFINDER_SLOTIMP_H_INCLUDED
...
public:
    ...
    boost::optional <BesselPublicKey> const& public_key () const
    {
        return m_public_key;
    }
    ...
    void public_key (BesselPublicKey const& key)
    {
        m_public_key = key;
    }
...
private:
    ...
    boost::optional<BesselPublicKey> m_public_key;
