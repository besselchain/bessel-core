...
#ifndef BESSEL_OVERLAY_OVERLAYIMPL_H_INCLUDED
#define BESSEL_OVERLAY_OVERLAYIMPL_H_INCLUDED
...
private:
    ...
    hash_map<BesselAddress, std::weak_ptr<PeerImp>> m_publicKeyMap;
...
public:
    ...
    */
    ...
    void
    onPeerDeactivate (Peer::id_t id, BesselAddress const& publicKey);
