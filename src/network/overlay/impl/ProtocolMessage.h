...
#ifndef BESSEL_OVERLAY_PROTOCOLMESSAGE_H_INCLUDED
#define BESSEL_OVERLAY_PROTOCOLMESSAGE_H_INCLUDED

#include <network/bessel.pb.h>
#include <network/overlay/Message.h>
#include <network/overlay/impl/ZeroCopyStream.h>
...
typename std::enable_if<std::is_base_of<::google::protobuf::Message, T>::value, boost::system::error_code>::type
invoke (int type, Buffers const& buffers, Handler& handler)
{
