...
#ifndef BESSEL_OVERLAY_OVERLAY_H_INCLUDED
#define BESSEL_OVERLAY_OVERLAY_H_INCLUDED
...
{
protected:
    //  NOTE The requirement of this constructor is an
...
public:
    ...
    */
    virtual
    void
    connect (boost::asio::ip::tcp::endpoint const& address) = 0;
