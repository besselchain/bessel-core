...
#ifndef BESSEL_RESOURCE_ENTRY_H_INCLUDED
#define BESSEL_RESOURCE_ENTRY_H_INCLUDED

#include <beast/chrono/abstract_clock.h>
#include <common/base/DecayingSample.h>
#include <network/resource/impl/Key.h>
#include <network/resource/impl/Tuning.h>
#include <cassert>
...
//  DEPRECATED using boost::intrusive list
struct Entry 
    : public boost::intrusive::list_base_hook<boost::intrusive::link_mode<boost::intrusive::normal_link>>
{
    ...
    */
    ...
    std::string to_string() const
    {
        switch (key->kind)
        {
        case kindInbound:   return key->address.ep.address().to_string();
        case kindOutbound:  return key->address.ep.address().to_string();
