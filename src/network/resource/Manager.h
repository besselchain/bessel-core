...
#ifndef BESSEL_RESOURCE_MANAGER_H_INCLUDED
#define BESSEL_RESOURCE_MANAGER_H_INCLUDED
...
public:
    ...
    virtual Consumer newInboundEndpoint (boost::asio::ip::tcp::endpoint const& address) = 0;

    /** Create a new endpoint keyed by outbound IP address and port. */
    virtual Consumer newOutboundEndpoint (boost::asio::ip::tcp::endpoint const& address) = 0;
