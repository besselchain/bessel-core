...
#ifndef BESSEL_RESOURCE_CONSUMER_H_INCLUDED
#define BESSEL_RESOURCE_CONSUMER_H_INCLUDED

#include <network/resource/Charge.h>
#include <network/resource/Disposition.h>
