...
Json::Value getMasterGenerator (
    Ledger::ref lrLedger, BesselAddress const& naRegularSeed,
    BesselAddress& naMasterGenerator, NetworkOPs& netOps)
{
    // BesselAddress       na0Public;      // To find the generator's index.
    // BesselAddress       na0Private;     // To decrypt the master generator's cipher.
    // BesselAddress       naGenerator = BesselAddress::createGeneratorPublic (naRegularSeed);
