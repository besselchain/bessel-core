...
#ifndef BESSEL_RPC_TRANSACTIONSIGN_H_INCLUDED
#define BESSEL_RPC_TRANSACTIONSIGN_H_INCLUDED
    ...
    namespace RPC {
        ...
        namespace RPCDetail {
            ...
            public:
                ...
                void snapshotAccountState(BesselAddress const& accountID);
                ...
                bool checkQuorum(BesselAddress const& account, std::map<Account, std::pair<KeyPair,bool> >& key_pairs) const;
