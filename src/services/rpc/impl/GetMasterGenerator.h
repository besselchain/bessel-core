...
#ifndef BESSEL_RPC_GETMASTERGENERATOR_H_INCLUDED
#define BESSEL_RPC_GETMASTERGENERATOR_H_INCLUDED
...
Json::Value getMasterGenerator (
    Ledger::ref lrLedger,
    BesselAddress const& naRegularSeed,
    BesselAddress& naMasterGenerator,
    NetworkOPs& netOps);
