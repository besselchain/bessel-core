...
#ifndef BESSEL_SERVER_SESSION_H_INCLUDED
#define BESSEL_SERVER_SESSION_H_INCLUDED
    ...
    */
    ...
    write (BufferSequence const& buffers)
    {
            ...
            iter != buffers.end(); ++iter)
        {
            ...
            write (boost::asio::buffer_cast <void const*> (buffer), boost::asio::buffer_size (buffer));
        }
    }
