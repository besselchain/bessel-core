...
#ifndef BESSEL_VALIDATORS_MANAGER_H_INCLUDED
#define BESSEL_VALIDATORS_MANAGER_H_INCLUDED
...
public:
    ...
    */
    ...
    virtual
    void
    onLedgerClosed (LedgerIndex index, LedgerHash const& hash, LedgerHash const& parent) = 0;
};
