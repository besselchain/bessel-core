...
{
    //  TODO Give the return value a descriptive local variable name
    ...
    if (proposing) // give ourselves full weight
    {
        ...
        //  TODO Rename these macros and turn them into language
    ...
    {
        WriteLog (lsINFO, LedgerConsensus) << "No change (" << (mOurVote ? "YES" : "NO") << ") : weight "
                                           << weight 
                                           << ", percent " << percentTime;
    ...
    WriteLog (lsDEBUG, LedgerConsensus) << "We now vote " 
                                        << (mOurVote ? "YES" : "NO")
                                        << " on " << mTransactionID;
