...
#ifndef BESSEL_CRYPTO_CBIGNUM_H_INCLUDED
#define BESSEL_CRYPTO_CBIGNUM_H_INCLUDED
...
//  TODO figure out a way to remove the dependency on openssl in the
...
//  I believe only STAmount uses these
