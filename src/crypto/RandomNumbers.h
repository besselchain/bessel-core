...
#ifndef BESSEL_CRYPTO_RANDOMNUMBERS_H_INCLUDED
#define BESSEL_CRYPTO_RANDOMNUMBERS_H_INCLUDED
...
template <class T, class = typename std::enable_if<std::is_pod<T>::value>::type>
void
